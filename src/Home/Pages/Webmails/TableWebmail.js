...
import { DataWebmail } from "./../Data/data";
import { useSelector } from "react-redux";
import Buymodal from "./../Buymodal";
import Swal from 'sweetalert2';
import { useState, useEffect } from "react";
import cart from "./../../../images/shopping.svg";
function TableWebmail(props) {
        ...
        <>
            ...
            <div className="table1">
                <table className="table table-striped">
                    ...
                    <tbody>
                        {
                            DataWebmail.filter((ele) => state.Website.toLowerCase() !== "" ? ele.website.toLowerCase().includes((state.Website).toLowerCase())
                                : state.Host.toLowerCase() !== "" ? ele.hosting.toLowerCase().includes((state.Host).toLowerCase())
                                    : state.Type.toLowerCase() !== "" ? ele.type.toLowerCase().includes((state.Type).toLowerCase())
